//
//  EziSocailDemoAppController.mm
//  EziSocailDemo
//
//  Created by Paras Mendiratta on 21/04/13.
//  Copyright EziByte 2013. All rights reserved.
//
...
// Add this to Make EziSocial Plugin working on iOS Platform
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString* projectIdentifier = [infoDictionary objectForKey:@"CFBundleIdentifier"];
    
    NSLog(@"Bundle Identifier = %@", projectIdentifier);
